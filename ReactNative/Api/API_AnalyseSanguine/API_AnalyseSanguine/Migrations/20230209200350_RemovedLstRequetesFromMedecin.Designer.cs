...
namespace API_AnalyseSanguine.Migrations
{
    ...
    [Migration("20230209200350_RemovedLstRequetesFromMedecin")]
    partial class RemovedLstRequetesFromMedecin
    {
            ...
            modelBuilder.Entity("API_AnalyseSanguine.Models.RequeteAnalyse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdRequete = 1,
                            AnalyseDemande = "",
                            CodeAcces = new Guid("ab40a2c0-855e-4ca8-bfc8-170fbfe8bff9"),
                        ...
                        new
                        {
                            IdRequete = 2,
                            AnalyseDemande = "",
                            CodeAcces = new Guid("fef07ed8-7439-4e85-b47a-e8381f2a8de7"),
                        ...
                        new
                        {
                            IdRequete = 3,
                            AnalyseDemande = "",
                            CodeAcces = new Guid("ab76c71f-9e51-452a-9769-d841ad9c94df"),
                        ...
                        new
                        {
                            IdRequete = 4,
                            AnalyseDemande = "",
                            CodeAcces = new Guid("4fbec4fc-1737-4970-a237-b036845fbf6f"),
                        ...
                        new
                        {
                            IdRequete = 5,
                            AnalyseDemande = "",
                            CodeAcces = new Guid("95e111ff-f763-47ed-b5bc-1d0aab346c02"),
                        ...
                        new
                        {
                            IdRequete = 6,
                            AnalyseDemande = "",
                            CodeAcces = new Guid("daf40df2-6fff-45b1-a643-774b9abebbaf"),
